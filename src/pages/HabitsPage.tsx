...
export default function HabitsPage() {
  ...
  const toggleToday = async (h: HabitTracker) => {
    ...
    await updateItem<HabitTracker>("habits", h.id, {
    ...
    <div className="space-y-5 sm:space-y-6">
      <div className="section-header">
        ...
        <div className="flex items-center gap-2">
          ...
          <button onClick={openAdd} className="btn-primary text-xs sm:text-sm">
            <Plus size={14} /> <span className="hidden sm:inline">New</span> Habit
          </button>
        </div>
      </div>
