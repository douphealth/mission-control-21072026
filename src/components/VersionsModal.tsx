          ...
          <div className="fixed inset-0 z-50 flex items-center justify-center p-4 pointer-events-none">
            <div className="pointer-events-auto w-full max-w-3xl max-h-[90vh] flex flex-col bg-card border border-border/60 rounded-2xl shadow-2xl overflow-hidden">
              ...
              <div className="flex-1 overflow-auto">
                {loading ? (
                  ...
                  <div className="p-12 text-center text-muted-foreground text-sm">
                    ...
                    No versions yet. Click <b>Save version</b> above — or just keep editing,
                    auto-snapshots run in the background.
                  </div>
                ) : (
              ...
              <div className="px-6 py-3 border-t border-border/30 text-[11px] text-muted-foreground flex items-center gap-2">
                ...
                Restoring always creates a "safety" version of your current data first — nothing is
                ever lost.
              </div>
            </div>
          </div>
            ...
            >
              ...
              >
                ...
                <p className="text-sm text-muted-foreground mb-4">
                  Your current data will be replaced with <b>{confirmRestore.name}</b>. A safety
                  version of right-now will be saved automatically, so you can undo this in one
                  click.
                </p>
