...
async function deriveKeyWithSalt(passphrase: string, salt: Uint8Array, iterations = ITERATIONS): Promise<CryptoKey> {
...
async function tryDecrypt(key: CryptoKey, iv: Uint8Array, data: Uint8Array): Promise<string | null> {
    try {
...
export async function decryptOrNull(cipherText: string, customKey?: string): Promise<string | null> {
    try {
