...
export const widgetDefinitions: WidgetDefinition[] = [
  ...
  },
  {
    ...
    description: "Timer & daily inspiration",
  },
  ...
  },
  {
    ...
    description: "Approaching due dates",
  },
  {
    id: "habits",
    type: "habits",
    ...
    icon: "🔥",
    category: "productivity",
    defaultLayout: { w: 3, h: 7, minW: 3, minH: 5 },
  ...
  },
  {
    ...
    description: "Progress ring & top ideas",
  },
  {
    id: "notes-preview",
    type: "notes-preview",
    ...
    icon: "📝",
    category: "business",
    defaultLayout: { w: 3, h: 6, minW: 3, minH: 4 },
    description: "Quick note access",
  },
  ...
  // Platforms
  {
    ...
    description: "Team activity & status",
  },
  {
    id: "quick-links",
    type: "quick-links",
    ...
    category: "platforms",
    defaultLayout: { w: 4, h: 5, minW: 3, minH: 4 },
    description: "Build projects overview",
  },
  {
    id: "websites-summary",
    type: "websites-summary",
    title: "Websites",
    icon: "🌐",
    category: "platforms",
    defaultLayout: { w: 3, h: 5, minW: 3, minH: 4 },
    description: "Website status tracker",
  },
];
...
export function getDefaultLayouts(
  ...
  return widgetDefinitions.map((def) => {
    ...
    return {
      ...
      x: 0,
      y: 999,
      w: Math.min(def.defaultLayout.w, cols),
